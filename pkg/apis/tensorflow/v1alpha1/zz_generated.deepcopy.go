...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ReplicaStateStatic) DeepCopyInto(out *ReplicaStateStatic) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ReplicaStateStatic.
func (in *ReplicaStateStatic) DeepCopy() *ReplicaStateStatic {
	if in == nil {
		return nil
	}
	out := new(ReplicaStateStatic)
	in.DeepCopyInto(out)
	return out
}
...
func (in *TFReplicaStatus) DeepCopyInto(out *TFReplicaStatus) {
	*out = *in
	...
	if in.ReplicasStaticsMap != nil {
		in, out := &in.ReplicasStaticsMap, &out.ReplicasStaticsMap
		*out = make(map[ReplicaState]*ReplicaStateStatic, len(*in))
		for key, val := range *in {
			var outVal *ReplicaStateStatic
			if val == nil {
				(*out)[key] = nil
			} else {
				in, out := &val, &outVal
	...
	if in.ReplicasStaticsSlice != nil {
		in, out := &in.ReplicasStaticsSlice, &out.ReplicasStaticsSlice
		*out = make([]*ReplicaStateStatic, len(*in))
		for i := range *in {
			if (*in)[i] == nil {
				(*out)[i] = nil
			} else {
